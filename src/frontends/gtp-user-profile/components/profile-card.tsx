...
import { Card, CardContent, List, ListItemButton, ListItemText, Typography, Box, Grid2, Dialog, DialogActions, DialogContent, DialogTitle, Button, Avatar, IconButton, ListItem, Tooltip } from "@mui/material";
...
export default function ProfileCard() {
  const [selectedOption, setSelectedOption] = useState<"profile" | "clubs">("profile");
      ...
      <Card 
        ...
        <CardContent>
          <Box 
            ...
            <Typography variant="h4" gutterBottom sx={{ color: '#FFFFFF', mt: 2}}>
          ...
          <ListItemButton
            ...
            sx={{
              borderRadius: 5,
              mb: 1,
              backgroundColor: selectedOption === "profile" ? 'white' : 'transparent',
              '&:hover': {
                backgroundColor: selectedOption === "profile" ? 'white' : 'transparent',
              },
              '&.Mui-selected': {
          ...
          >
            <Typography
              variant="h5"
              color={selectedOption === "profile" ? '#1F5132' : '#FFFFFF'}
            >
              Profile Settings
            </Typography>
          </ListItemButton>
          <ListItemButton
            ...
            sx={{
              borderRadius: 5,
              mb: 1,
              backgroundColor: selectedOption === "clubs" ? 'white' : 'transparent',
              '&:hover': {
                backgroundColor: selectedOption === "clubs" ? 'white' : 'transparent',
              },
              '&.Mui-selected': {
          ...
          >
            <Typography
              variant="h5"
              color={selectedOption === "clubs" ? '#1F5132' : '#FFFFFF'}
            >
              Clubs
            </Typography>
          </ListItemButton>
